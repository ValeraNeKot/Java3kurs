...
//	    }
	    ...
	    public Student(long id, String fname, String lname, String address, String mobileNo, String mailId, String city, String designation, Date dob, Date doj, BigDecimal salary, Timestamp addDate) {
	        this.id = id;
	        this.fname = fname;
	        this.lname = lname;
	        this.address = address;
